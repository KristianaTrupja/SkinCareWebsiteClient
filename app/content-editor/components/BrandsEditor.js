...
const BrandsEditor = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post('http://localhost:5001/brands', content); 
  ...
  return (
        <div className="bg-white w-full p-8 border-2 border-solid border-primary">
          <h1 className="text-3xl font-semibold text-center text-softGold mb-6">Brands Content Editor</h1>
