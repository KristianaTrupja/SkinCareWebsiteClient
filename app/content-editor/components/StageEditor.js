...
const StageEditor = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post('http://localhost:5000/stage-content/create-stage', content);
  ...
  return (
        <div className="bg-white w-full p-8 border-2 border-solid border-primary">
          <h1 className="text-3xl font-semibold text-center text-softGold mb-6">Stage Module Content Editor</h1>
